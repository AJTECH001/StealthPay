              ...
              <GlassCard className="p-8 space-y-6">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 bg-white/5 p-3 rounded-xl border border-white/5 group">
                    <p className="text-[10px] font-mono text-white break-all leading-relaxed flex-1">
                      {address}
                    </p>
                    <CopyButton text={address} className="text-slate-500 hover:text-white" />
                  </div>
                </div>
            ...
            >
              <GlassCard className="h-full p-6 md:p-10 flex flex-col gap-8">
                <div className="flex flex-col gap-4">
                  <div className="space-y-1">
                    <h2 className="text-2xl font-bold text-white tracking-tight">Merchant History</h2>
